...
public class TestPortalMessagesOld {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String[] paragraphs = pageHtml.split("\r\n");
            ...
            for (String text : paragraphs) {
                ...
                if (text.toLowerCase().contains("getblob")) {
                    Document tag = Jsoup.parse(text);
                    ...
                    if (SearchUtils.isEmpty(subject) && SearchUtils.isEmpty(body)){
                        subject = text;
                    }else {
